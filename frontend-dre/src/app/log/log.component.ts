...
export class LogComponent implements OnInit, AfterViewInit {
  ...
  constructor(private http: HttpClient,private logService: LogService, private router: Router ,private personnelService: PersonnelService, private renderer: Renderer2, private el: ElementRef,private readonly keycloakService: KeycloakService) {}
